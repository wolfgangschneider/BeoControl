...
1. Download the Windows installer for your architecture:
   - `BeoControl-win-x64-self-contained-Setup.exe`
   - `BeoControl-win-x64-framework-dependent-Setup.exe`
   - `BeoControl-win-arm64-self-contained-Setup.exe`
   - `BeoControl-win-arm64-framework-dependent-Setup.exe`
2. Run the installer.
3. Velopack installs the app to `%LocalAppData%\BeoControl`.
...
1. Download the AppImage for your architecture:
   - `BeoControl-linux-x64-self-contained.AppImage`
   - `BeoControl-linux-x64-framework-dependent.AppImage`
   - `BeoControl-linux-arm64-self-contained.AppImage`
   - `BeoControl-linux-arm64-framework-dependent.AppImage`
